...
public class HomeScreen extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        totaltodo = view.findViewById(R.id.tv_total_todo);

        vhivlelivk = view.findViewById(R.id.ll_vehicle_trips);
...
//        setContentView(R.layout.activity_home_screen);
        ...
        creattrip = view.findViewById(R.id.ic_creat_trip);
        mainview = view.findViewById(R.id.ll_main_view);
        comingsun = view.findViewById(R.id.animation_coming_soon);
