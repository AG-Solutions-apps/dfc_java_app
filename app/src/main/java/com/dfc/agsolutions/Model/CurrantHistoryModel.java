...
public class CurrantHistoryModel {
    ...
    public CurrantHistoryModel.UserData1 getData() {
        return data;
    }

    public void setData(CurrantHistoryModel.UserData1 data) {
        this.data = data;
    }
    ...
    private int code;
    @SerializedName("data")
    private CurrantHistoryModel.UserData1 data;
