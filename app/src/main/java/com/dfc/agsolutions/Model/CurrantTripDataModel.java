...
public class CurrantTripDataModel {
    ...
    public CurrantTripDataModel.UserData1 getData() {
        return data;
    }

    public void setData(CurrantTripDataModel.UserData1 data) {
        this.data = data;
    }
    ...
    private int code;
    @SerializedName("data")
    private CurrantTripDataModel.UserData1 data;
