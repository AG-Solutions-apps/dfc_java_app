...
public class Allvhicale_list_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_allvhicale_list);
...
//                    Log.e("responce..", "branches:-  " + branches.size());
    ...
    public class Home_Today_list_Adapter extends RecyclerView.Adapter<Home_Today_list_Adapter.Holder> {
        ...
        public Home_Today_list_Adapter.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.itam_allvhicle, parent, false);
...
//                    Log.e("responce..", "branches:-  " + branches.size());
    ...
    private void countryDialoglogout(VhicaledetailsModel.DataModel data) {
        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(Allvhicale_list_activity.this, R.style.SheetDialog);
        ...
        TextView carname = bottomSheetDialog.findViewById(R.id.carname);
